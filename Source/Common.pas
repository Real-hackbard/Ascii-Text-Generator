...
procedure MsgError(Text, Caption: string);
begin
  MessageBox(Application.Handle, PWideChar(Text), PWideChar(Caption), MB_ICONERROR or MB_OK);
end;     
//--------------------------------------------------------------------
procedure MsgExclam(Text, Caption: string);
begin
  MessageBox(Application.Handle, PWideChar(Text), PWideChar(Caption), MB_ICONEXCLAMATION or MB_OK);
end;
//--------------------------------------------------------------------
procedure MsgWarning(Text, Caption: string);
begin
  MessageBox(Application.Handle, PWideChar(Text), PWideChar(Caption), MB_ICONWARNING or MB_OK);
end;
//--------------------------------------------------------------------
procedure MsgInfo(Text, Caption: string);
begin
  MessageBox(Application.Handle, PWideChar(Text), PWideChar(Caption), MB_ICONINFORMATION or MB_OK);
end;
//--------------------------------------------------------------------
function MsgConfirm(Text, Caption: string): boolean;
var i: integer;
begin
  i := MessageBox(Application.Handle, PWideChar(Text), PWideChar(Caption), MB_ICONQUESTION or MB_OKCANCEL);
  Result := (i=1);
end;
//--------------------------------------------------------------------
function StrReplace(S, Old, New: string) : string;
...
var
  F: TFileStream;
begin
  if FileExists(FileName) then DeleteFile(PWideChar(FileName));
  try
