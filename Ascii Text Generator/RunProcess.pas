...
type
  ...
  TRunProcess = class(TThread)
    private
      FStartInfo: TStartupInfo;           // Process start information
      FProcessInfo: TProcessInformation;  // Information about the process
      StdInThread: TStd;
      StdOutThread: TStd;
      StdErrThread: TStd;
...
begin
  ...
  {>> Do not execute more than one thing at a time per component }
  if IsRunning then
